...
class Command(BaseCommand):
    help = "สร้างชุดคำถามระดับ ป.3 - ม.ปลาย 350 ข้อ (เพิ่มข้อปานกลาง-ยาก 200 ข้อ พร้อมสุ่มกระจายตัวเลือก A, B, C, D) ซิงค์เข้า Firebase Firestore และ SQLite"
    ...
    def handle(self, *args, **kwargs):
        ...
        self.stdout.write(self.style.SUCCESS(f"[SUCCESS] สร้างชุดคำถาม 350 ข้อ พร้อมสุ่มเฉลย A-D สำเร็จ 100%!"))
        ...
        self.stdout.write(self.style.SUCCESS(f"  - สถิติระดับความยาก: ง่าย {easy_count} ข้อ, ปานกลาง {medium_count} ข้อ, ยาก {hard_count} ข้อ (เพิ่มข้อปานกลาง-ยากใหม่อีก 200 ข้อ)"))
